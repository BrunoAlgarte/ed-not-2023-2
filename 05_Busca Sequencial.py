def busca_sequencial(lista, val):
    ...
    """
    Função que realiza uma busca sequncial em uma lista procurando um val.
    Se val for encontrado, retorna a posição de val na lista
    Caso contrário, retorna o valor da convencional -1.

    """
   # Percorre a lista do início ao fim urando o range() e len()
...
# Para a busca sequencial, a lista NÂO PRECISA estar ordenada
...
print(f"Elemento 30 é encontrado na posição {pos30}.")
